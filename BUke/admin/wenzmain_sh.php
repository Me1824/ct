		...
		<div class="mian">
            <div class="main_1">
                ...
                <form name="form1" method="post" action="" align="center">
                    <input class="button1" type="button" value="文章管理" onclick="location.href='wenzmain.php'"  /></br>
                    <p/>文章审核<p/>
                    查询关键字&nbsp;
                ...
                <table id="tab1">
                    ...
                    $sql=mysql_query("select count(*) from article where status=0 and  title like '%$keyword%'  order by id asc",$conn);
                    //print_r($conn);
                    //查询符合条件的记录总条数
                    ...
                    $sql=mysql_query("select * from article where  status=0 and  title like  '%$keyword%'  order by id asc limit $offset, $page_size");
...
//应用while循环语句输出查询结果
                        ...
                        <tr>
                            ...
                            <td style="width:220px;"><?php echo substr($row->content, 0,154);?></td>
                            <td><?php echo $row->num;?></td>

                            <td>
                                <a href="wenzmain_sh_ok.php?id=<?php echo $row->id?>">审核</a>
