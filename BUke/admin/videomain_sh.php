...
<div class="box1">
	...
	<div class="box3">
		...
		<div class="mian">
			<div class="main_1">
<!--				<form>-->
<!--					<input class="button1" type="button" value="视频审核"  /></br>-->
<!--					<table id="tab1">-->
<!--						<tr>-->
<!--							<td>标题</td>-->
<!--							<td>封面</td>-->
...
<!--				</form>-->
                ...
                <form name="form1" method="post" action="" align="center">
                    <input class="button1" type="button" value="视频管理" onclick="location.href='videomain.php'" /></br>
                    <p/>视频审核<p/>
                    查询关键字&nbsp;
                ...
                <table id="tab1">
                    ...
                    $sql=mysql_query("select count(*) from video where status=0 and  vname like '%$keyword%'  order by id asc",$conn);
                    //print_r($conn);
                    //查询符合条件的记录总条数
                    ...
                    $sql=mysql_query("select * from video where  status=0 and  vname like  '%$keyword%'  order by id asc limit $offset, $page_size");
...
//应用while循环语句输出查询结果
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="videomain_sh_ok.php?id=<?php echo $row->id?>">审核</a>
                                <a href="videomain_delete.php?id=<?php echo $row->id?>">删除</a>
                            </td>
                        </tr>
                        <?php
                    ...
                    <table>
                        <tr>
                            ...
                            <td width="50%" align="right">
                                ...
                                if($page!=1){
                                    /*  显示“首页”超链接  */
                                    echo "<a href= videomain_sh.php?page=1&keyword=".$keyword.">首页</a>&nbsp;";
                                    /*  显示“上一页”超链接  */
                                    echo "<a href=videomain_sh.php?page=".($page-1)."&keyword=".$keyword.">上一页</a>&nbsp;";
                                }
                                else{
                                    echo "首页&nbsp;";
                                ...
                                if($page<$page_count){
                                    /*  显示“下一页”超链接  */
                                    echo "<a href=videomain_sh.php?page=".($page+1)."&keyword=".$keyword.">下一页</a>&nbsp;";
                                    /*  显示“尾页”超链接  */
                                    echo  "<a href=videomain_sh.php?page=".$page_count."&keyword=".$keyword.">尾页</a>";
                                }
                                else{
                                    echo "下一页&nbsp;";
                                    echo "尾页&nbsp;";
