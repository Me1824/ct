...
<!--				</form>-->
                ...
                <form name="form1" method="post" action="" align="center">
                    <input class="button1" type="button" value="视频审核" onclick="location.href='videomain_sh.php'"  /></br>
                    <p/>视频管理<p/>
                    查询关键字&nbsp;
                ...
                <table id="tab1">
                    ...
                    $sql=mysql_query("select count(*) from video where status=1 and  vname like '%$keyword%'  order by id asc",$conn);
                    //print_r($conn);
                    //查询符合条件的记录总条数
                    ...
                    $sql=mysql_query("select * from video where  status=1 and  vname like  '%$keyword%'  order by id asc limit $offset, $page_size");
