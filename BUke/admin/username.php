...
<!--				</table>-->
                ...
                <table>
                    ...
                    $sql=mysql_query("select count(*) from user where rid=1 and uname like '%$keyword%'  order by id asc",$conn);
                    //print_r($conn);
                    //查询符合条件的记录总条数
                    ...
                    $sql=mysql_query("select * from user where rid=1 and  uname like  '%$keyword%'  order by id asc limit $offset, $page_size");
...
//应用while循环语句输出查询结果
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="username_update.php?type=1&id=<?php echo $row->id?>">修改</a>
                                <a href="username_delete.php?type=1&id=<?php echo $row->id?>">删除</a>
                            </td>
                        </tr>
                        <?php
                    ...
                    <table>
                        <tr>
                            ...
                            <td width="50%" align="right">
                                ...
                                if($page!=1){
                                    /*  显示“首页”超链接  */
                                    echo "<a href= username.php?page=1&keyword=".$keyword.">首页</a>&nbsp;";
                                    /*  显示“上一页”超链接  */
                                    echo "<a href=username.php?page=".($page-1)."&keyword=".$keyword.">上一页</a>&nbsp;";
                                }
                                else{
                                    echo "首页&nbsp;";
                                ...
                                if($page<$page_count){
                                    /*  显示“下一页”超链接  */
                                    echo "<a href=username.php?page=".($page+1)."&keyword=".$keyword.">下一页</a>&nbsp;";
                                    /*  显示“尾页”超链接  */
                                    echo  "<a href=username.php?page=".$page_count."&keyword=".$keyword.">尾页</a>";
                                }
                                else{
                                    echo "下一页&nbsp;";
                                    echo "尾页&nbsp;";
