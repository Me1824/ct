...
<!--				</form>-->
                ...
                <table id="tab1">
                    ...
                    $sql=mysql_query("select count(*) from video where author=$id and  vname like '%$keyword%'  order by id asc",$conn);
                    //print_r($conn);
                    //查询符合条件的记录总条数
                    ...
                    $sql=mysql_query("select * from video where author=$id and  vname like  '%$keyword%'  order by id asc limit $offset, $page_size");
...
//应用while循环语句输出查询结果
                        ...
                        <tr>
                            ...
                            <td><img width="100px" height="100px" src="<?php echo '../upload/'.$row->url;?>"></td>
